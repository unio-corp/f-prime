  ...
  return (
    <div className="relative aspect-[1/1.25] overflow-hidden">
      <button
        ...
        className="relative h-full w-full cursor-pointer align-top focus-visible:shadow-none focus-visible:after:pointer-events-none focus-visible:after:absolute focus-visible:after:inset-0 focus-visible:after:shadow-[inset_0_0_0_2px_#0071e3] focus-visible:after:content-['']"
      >
