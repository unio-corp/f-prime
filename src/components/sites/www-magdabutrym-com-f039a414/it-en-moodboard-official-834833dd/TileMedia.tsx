...
/**
 * `.Media_responsiveWrap` + `.Viedo_videoElement` from the target site.
 * Videos autoplay, loop and are muted; images use `object-fit: cover`.
 */
export function TileMedia({
  ...
  // DEVIATION FROM TARGET: the live site plays all videos unconditionally,
  // regardless of the user's motion preference. This clone deliberately
  // pauses (and resumes) playback based on `prefers-reduced-motion` for
  // accessibility.
  useEffect(() => {
