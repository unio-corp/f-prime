...
import type { MoodboardProduct } from "@/types/moodboard";
 ...
 * scroller.
 */
export function ProductsPreviewModal({ item, onClose }: ProductsPreviewModalProps) {
  const modalRef = useRef<HTMLDivElement>(null);
  const closeButtonRef = useRef<HTMLButtonElement>(null);
  // Opens with a ~.3s opacity fade.
